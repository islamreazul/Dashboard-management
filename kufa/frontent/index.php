...
session_start();
$id = $_SESSION['auth_id'];
$user_db_query="SELECT  `name`, `email`, `Address`, `phone_number`, `profile_pic`, `facebook`, `twitter`, `instagram`, `linkedin` FROM `admins` WHERE id='$id'";
$user_db=mysqli_query($db_connect,$user_db_query);
$user_db_ruselt=mysqli_fetch_assoc($user_db);
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    <div class="contact-list mb-30">
                        <h4> Address</h4>
                        <p><?=$user_db_ruselt['Address']?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p><?=$user_db_ruselt['phone_number']?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Email Address</h4>
                        <p><?=$user_db_ruselt['email']?></p>
                    </div>
                </div>
                <div class="social-icon-right mt-20">
                    <a href="<?=$user_db_ruselt['facebook']?>"><i class="fab fa-facebook-f"></i></a>
                    <a href="<?=$user_db_ruselt['twitter']?>"><i class="fab fa-twitter"></i></a>
                    <a href="<?=$user_db_ruselt['linkedin']?>"><i class="fab fa-linkedin"></i></a>
                    <a href="<?=$user_db_ruselt['instagram']?>"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Will<?=$user_db_ruselt['name']?> </h2>
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        <li><a href="<?=$user_db_ruselt['facebook']?>"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="<?=$user_db_ruselt['twitter']?>"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="<?=$user_db_ruselt['instagram']?>"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="<?=$user_db_ruselt['linkedin']?>"><i class="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <img src="img/banner/ritu.png" width="400" height="700">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                    <?php
                      $work_query= "SELECT * FROM work WHERE work_status='active'";
                      ...
                      ?>
                            ...
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="../dashboard/work image/<?=$work['work_image']?>" width="100" height="300">
								</div>
								<div class="speaker-overlay">
									<span><?=$work['work_title']?></span>
									<h4><a href="portfolio-single.html"><?=$work['work_heading']?></a></h4>
									<a href="portfolio-single.html" class="arrow-btn"><?=$work['work_descaription']?> <span></span></a>
								</div>
							</div>
                        </div>
                            ...
                            <div class="contact-form">
                                <?php
                                  if (isset($_SESSION['sent'])) {?>
                                    <h4 class="text-success"><?=$_SESSION['sent'];?></h4>
                                    <?php
                                     } unset($_SESSION['sent']);
                                  ?>
