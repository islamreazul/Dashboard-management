                                ...
                                <table class="table   table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($db_educations_result as  $education):
                                            ...
                                            <td>
                                                <div >
                                                    <a href="./upadate_education.php?id=<?=$education["id"] ?>" class="btn btn-sm btn-primary">Edit</a>
                                                    <a href="./education_delete.php?id=<?= $education["id"]?>" class="btn btn-sm btn-primary">Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                            <?php
