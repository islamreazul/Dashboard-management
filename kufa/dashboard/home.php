                ...
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="components-cards.html" class="active">Cards</a>
                            </li>
                            <li>
                ...
                <div class="content-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card">
                                    <img src="./assets//images/cards/card.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card">
                                  ...
                                  <div class="card bg-dark text-white">
                                    <img src="./assets//images/cards/card.png" class="card-img" alt="...">
                                    <div class="card-img-overlay">
                                      <h5 class="card-title text-white">Card title</h5>
                                      <p class="card-text m-t-md">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                  ...
                                  <div class="card">
                                    ...
                                    <img src="./assets//images/cards/card.png" class="card-img-bottom" alt="...">
                                  </div>
                                  <div class="card text-center">
                                    <div class="card-header">
                                      Featured
