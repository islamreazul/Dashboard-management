...
?>
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
                                    <h1>Dashboard</h1>
                                    <h2>Hello  <?=$_SESSION['auth_name']?>< <?=$_SESSION['auth_email']?>></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-indicator widget-stats-indicator-positive align-self-start">
                                                <i class="material-icons">keyboard_arrow_right</i> 12%
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                        <?php
                                    $users_query ="SELECT id,name,email FROM admins ORDER BY name LIMIT 9";
                                    ...
                                    $total_users_result =mysqli_fetch_assoc($total_users_db);
                                   
                                    ?>
                            <div class="col-xl-6">
                                <div class="card widget widget-list" style="height:470px ; overflow-Y : scroll;">
                                    <div class="card-header">
                                        <h5 class="card-title">Active  users<span class="badge badge-success badge-style-light"> <?= $total_users_result['total'] ?> users</span></h5>
                                    </div>
                                   
                                    <div class="card-body">
                                        <span class="text-muted m-b-xs d-block">showing <?=$users_query_db->num_rows?> out of <?= $total_users_result['total']?> active tasks.</span>
